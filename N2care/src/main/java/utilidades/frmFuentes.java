...
public class frmFuentes extends javax.swing.JDialog {
    ...
    public frmFuentes(java.awt.Frame parent, boolean modal, Font fuente, Color color) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jpEnfermedades, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
    ...
    private void btnColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnColorActionPerformed
        jlFuente.setForeground(JColorChooser.showDialog(this,
