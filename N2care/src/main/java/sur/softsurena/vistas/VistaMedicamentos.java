 ...
 * @author jhironsel
 */
public final class VistaMedicamentos extends javax.swing.JInternalFrame {

    private static final long serialVersionUID = 1L;

    private static VistaMedicamentos medicamentos;
    ...
    private static JComboExp miCombo;
    ...
    public synchronized static VistaMedicamentos getMedicamentos() {

        if (medicamentos == null) {
            medicamentos = new VistaMedicamentos();
        }
        return medicamentos;
    }
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        if (resp.equals("Crear Medicamento")) {
            ...
            jlFoto.setIcon(new Imagenes("Pildora 180 x 180.png").getIcono());
...
//        tblMedicamentos.setRowSelectionInterval(0, 0);
    ...
    private void txtCodigoProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCodigoProveedorActionPerformed
        int resp1 = JOptionPane.showInternalConfirmDialog(this,
...
//        ResultSet rs = getMedicamento(estado); los medicamentos se buscan por estado.
        ...
        M_Proveedor.select(
                ...
                proveedor ->{
                    ...
                    registro[2] = "Nombre del medicamento";
                    registro[3] = "Estado";
