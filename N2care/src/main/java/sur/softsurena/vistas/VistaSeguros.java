 ...
 * @author jhironsel
 */
public final class VistaSeguros extends javax.swing.JInternalFrame {

    private static VistaSeguros seguros;
    ...
    public synchronized static VistaSeguros getSeguros() {
        if (seguros == null) {
            seguros = new VistaSeguros();
        }
        return seguros;
    }
