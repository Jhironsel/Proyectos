...
public final class VistaGestionConsultas extends javax.swing.JInternalFrame {
    ...
    private static VistaGestionConsultas citas;
    
    public VistaGestionConsultas() {
    ...
    public synchronized static VistaGestionConsultas getCitas() {
        
        if (citas == null) {
            citas = new VistaGestionConsultas();
        }
    ...
    private void initComponents() {
        ...
        dcConsulta.getDateEditor().addPropertyChangeListener(
            ...
            layout.setHorizontalGroup(
                ...
                .addComponent(jtpFormularios, javax.swing.GroupLayout.DEFAULT_SIZE, 814, Short.MAX_VALUE)
