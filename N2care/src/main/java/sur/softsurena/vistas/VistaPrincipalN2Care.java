...
public final class VistaPrincipalN2Care extends javax.swing.JFrame {

    private static final long serialVersionUID = 1L;

    public VistaPrincipalN2Care() {
        ...
        //principal
//        txtUsuario.setText(
//                "Usuario: " + VistaLoginN2Care.txtUsuario.getText() + "\n Rol: "
//        );
    ...
    private void mnuArchivoCerrarSeccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuArchivoCerrarSeccionActionPerformed
        final SwingWorker<?, ?> w = new SwingWorker<>() {
            ...
            protected Object doInBackground() throws Exception {
                ...
                VistaLoginN2Care l = new VistaLoginN2Care();
