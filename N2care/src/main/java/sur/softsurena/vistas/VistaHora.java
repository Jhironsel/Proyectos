 ...
 * @author jhironsel
 */
public final class VistaHora extends javax.swing.JDialog {
    
    private static final long serialVersionUID = 1L;
    
    public static boolean aceptar = false;
    
    public VistaHora(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
