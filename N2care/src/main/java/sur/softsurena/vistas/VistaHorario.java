...
public final class VistaHorario extends javax.swing.JInternalFrame {
    ...
    private static VistaHorario controlCita;
    ...
    public synchronized static VistaHorario getControlCita() {

        if (controlCita == null) {
            controlCita = new VistaHorario();
        }
        return controlCita;
    }
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        VistaDiasConsultas dc = new VistaDiasConsultas(
                null,
                true
        );
        //cbDoctores.getSelectedItem().toString() este medoto quedo fuera del constructor anterior. 
