...
public class VistaPrincipal extends javax.swing.JFrame implements Runnable {
    ...
    VistaRegistroPadre miPadre = new VistaRegistroPadre();
    VistaModificarPadre miPadreModificar = new VistaModificarPadre();
    VistaRegistroEstudiante miEstudiante = new VistaRegistroEstudiante();
    VistaModificarEstudiante miMEstudiante = new VistaModificarEstudiante();
    VistaConsultaEstudiante miCEstudiante = new VistaConsultaEstudiante();
    VistaRegistroUsuarios miUsuarios = new VistaRegistroUsuarios();
    VistaModificarUsuarios miUsuarioModificar = new VistaModificarUsuarios();
    VistaPagos miPago = new VistaPagos();
    VistaAbonos miAbono = new VistaAbonos();
    VistaReporteEstudiante miReporte = new VistaReporteEstudiante();
    ...
    VistaUbicacionReportes miUbicacion = new VistaUbicacionReportes();
...
//        }//Arriba Bien....
    ...
    private void mnuPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuPagoActionPerformed
        ...
        new Thread(new VistaPrincipal(), "AbriendoPagos").start();
//        try {
...
//        }
    ...
    private void mnuContactarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuContactarActionPerformed
        VistaPresentacion miJD = new VistaPresentacion(this, rootPaneCheckingEnabled);
