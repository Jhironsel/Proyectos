...
public final class VistaBusquedaPersona extends javax.swing.JDialog {
    ...
    private void llenarTabla() {
        String titulos[] = {"Lista de Persona"};
        ...
        } else if (cbEntidades.getSelectedItem().toString().equalsIgnoreCase("Clientes")) {
        ...
        } else if (cbEntidades.getSelectedItem().toString().equalsIgnoreCase("Empleados")) {
        ...
        } else if (cbEntidades.getSelectedItem().toString().equalsIgnoreCase("Estudiantes")) {
        ...
        } else if (cbEntidades.getSelectedItem().toString().equalsIgnoreCase("Pacientes")) {
        ...
        } else if (cbEntidades.getSelectedItem().toString().equalsIgnoreCase("Padres")) {
        ...
        } else if (cbEntidades.getSelectedItem().toString().equalsIgnoreCase("Proveedores")) {
