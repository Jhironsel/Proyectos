...
public final class VistaPersonas extends javax.swing.JInternalFrame {
    ...
    final static String[] TITULOS_PERSONA = {
        "Cedulas", "Persona", "Nombres y Apellidos", "Sexo", "Fecha nacimiento",
    ...
    private void initComponents() {
        ...
        btnGEstadoPersonas = new javax.swing.ButtonGroup();
        ...
        btnGEstadoPersonas.add(jRadioButtonMenuItem1);
        jRadioButtonMenuItem1.setSelected(true);
        jRadioButtonMenuItem1.setText("Activos");
        jRadioButtonMenuItem1.setName("jRadioButtonMenuItem1"); // NOI18N
        jMenu4.add(jRadioButtonMenuItem1);

        btnGEstadoPersonas.add(jRadioButtonMenuItem2);
        jRadioButtonMenuItem2.setText("Inactivos");
        jRadioButtonMenuItem2.setName("jRadioButtonMenuItem2"); // NOI18N
        jMenu4.add(jRadioButtonMenuItem2);

        btnGEstadoPersonas.add(jRadioButtonMenuItem3);
        jRadioButtonMenuItem3.setText("Ambos");
    ...
    private void btnGuardarRegistroActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnGuardarRegistroActionPerformed
        ...
        mensajeResultado(
                v_nuevo ? M_Generales.insert(general) : M_Generales.update(general)
        );
...
//                tblDireccion.getSelectedRow(), 3)).getId();
    ...
    public static void llenarTablaPersonas(Persona _persona) {
        ...
        if (btnGTipoPersona.isSelected(jcbFiltroClientes.getModel())) {
            M_Cliente.select(
                    Cliente
                            .builder()
                            .pagina(paginas())
                    ...
                    cliente -> {
                        dtmPersonas.addRow(buscarPersona(cliente.getId()));
                    }
            );
        }

        if (btnGTipoPersona.isSelected(jcbFiltroEmpleados.getModel())) {
            M_Empleado.select(
                    Empleado
                            .builder()
                            .pagina(paginas())
                    ...
                    empleado -> {
                        dtmPersonas.addRow(buscarPersona(empleado.getId()));
                    }
            );
        }

        if (btnGTipoPersona.isSelected(jcbFiltroEstudiantes.getModel())) {
            M_Estudiante.select(
                    Estudiante
                            .builder()
                            .pagina(paginas())
                    ...
                    estudiante -> {
                        dtmPersonas.addRow(buscarPersona(estudiante.getId()));
                    }
            );
        }

        if (btnGTipoPersona.isSelected(jcbFiltroPacientes.getModel())) {
            M_Paciente.select(
                    Paciente
                            .builder()
                            .pagina(paginas())
                    ...
                    paciente -> {
                        dtmPersonas.addRow(buscarPersona(paciente.getId()));
                    }
            );
        }

        if (btnGTipoPersona.isSelected(jcbFiltroPadres.getModel())) {
            M_Padre.select(
                    Padre
                            .builder()
                            .pagina(paginas())
                    ...
                    padre -> {
                        dtmPersonas.addRow(
                                buscarPersona(padre.getId())
                        );
                    }
            );
        }

        if (btnGTipoPersona.isSelected(jcbFiltroProveedores.getModel())) {
            M_Proveedor.select(
                    Proveedor
                            .builder()
                            .pagina(paginas())
    ...
    private boolean validarRegistroPersona() {
        ...
        //Validacion de cumplimiento del algoritmo. 
    ...
    private boolean mensajeRegistro() {
        ...
        if (v_nuevo) {
            ...
            if (M_Generales.select(
                    Generales
                            .builder()
                            .cedula(txtCedula.getValue().toString())
                            .build()
            ).getFirst().getIdPersona() != 0) {
    ...
    private javax.swing.ButtonGroup btnGEstadoPersonas;
    ...
    private void setEntidadesFalse() {
        jcbCliente.setSelected(false);
        jcbEmpleado.setSelected(false);
        jcbEstudiante.setSelected(false);
        jcbPaciente.setSelected(false);
        jcbPadre.setSelected(false);
        jcbProveedor.setSelected(false);
    }
