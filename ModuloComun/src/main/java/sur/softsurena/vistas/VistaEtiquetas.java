...
public final class VistaEtiquetas extends javax.swing.JDialog {

    private static final long serialVersionUID = 1L;

    public boolean aceptar;
    public VistaEtiquetas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    
    public VistaEtiquetas(java.awt.Frame parent, boolean modal, String propiedad, 
            String valor
    ) {
        super(parent, modal);
        initComponents();
