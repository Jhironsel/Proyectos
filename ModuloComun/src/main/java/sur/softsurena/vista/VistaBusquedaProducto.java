...
public final class VistaBusquedaProducto extends javax.swing.JDialog {
    ...
    public VistaBusquedaProducto(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtCriterio.addActionListener(this::txtCriterioActionPerformed);
