...
public class VistaLogin extends javax.swing.JFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        SwingWorker w = new SwingWorker() {
            ...
            protected Object doInBackground() throws Exception {
                ...
                if (Conexion.validarUsario(txtUsuario, txtClave, VistaLogin.this)) {
                    new VistaPrincipal().setExtendedState(JFrame.MAXIMIZED_BOTH);
                    dispose();
                }
                return null;
            }
    ...
    public static void main(String[] args) {
       ...
       // System.out.println("Ruta: " + System.getProperty("user.dir"));
        ...
        VistaLogin miUsuario = new VistaLogin();
