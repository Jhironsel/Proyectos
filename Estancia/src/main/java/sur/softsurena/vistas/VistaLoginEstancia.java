...
public final class VistaLoginEstancia extends javax.swing.JFrame {

    public static Datos datos;
    private static final long serialVersionUID = 1L;

    public VistaLoginEstancia() {
        initComponents();
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        SwingWorker<?,?> w = new SwingWorker<>() {
            ...
            protected Object doInBackground() throws Exception {
                ...
                if (Conexion.validarUsuario(txtUsuario, txtClave, VistaLoginEstancia.this)) {
                    new VistaPrincipalEstancia().setExtendedState(JFrame.MAXIMIZED_BOTH);
                    dispose();
                }
                return null;
            }
    ...
    public static void main(String[] args) {
        ...
        VistaLoginEstancia miUsuario = new VistaLoginEstancia();
