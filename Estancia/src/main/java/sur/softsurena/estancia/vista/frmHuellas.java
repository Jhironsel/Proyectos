...
public class frmHuellas extends javax.swing.JDialog {
    ...
    public frmHuellas(String cedula) {
        initComponents();
            ...
            try {
                ...
                switch (Reclutador.getTemplateStatus()) {
                    ...
                    case TEMPLATE_STATUS_FAILED: // informe de fallas y reiniciar la captura de huellas
                        ...
                        EstadoHuellas();
                        setTemplate(null);
                        JOptionPane.showMessageDialog(frmHuellas.this, "La Plantilla de la Huella no pudo ser creada, Repita el Proceso", "Inscripcion de Huellas Dactilares", JOptionPane.ERROR_MESSAGE);
                        start();
                        break;
                }
            }
