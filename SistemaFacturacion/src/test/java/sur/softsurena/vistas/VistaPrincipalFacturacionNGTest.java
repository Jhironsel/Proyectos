...
import static sur.softsurena.vistas.VistaPrincipalFacturacion.abrirFormulario;
/**
 *
 * @author jhironsel
 */
...
public class VistaPrincipalFacturacionNGTest {

    private VistaPrincipalFacturacion principal;
    private Entidades entidades;

    @Test
    public void testInicial() {
        principal = new VistaPrincipalFacturacion();
        entidades = Entidades
                .builder()
                .cliente(true)
                .empleado(true)
...
//            Logger.getLogger(VistaPrincipalFacturacionNGTest.class.getName()).log(Level.SEVERE, null, ex);
//        }
//    }
//
...
//    }
    ...
    public void testCerrarTodos() {
        VistaPrincipalFacturacion instance = new VistaPrincipalFacturacion();
    ...
    public void testAbrirFormularioCentralizado() {
        VistaPrincipalFacturacion.abrirFormularioCentralizado(
