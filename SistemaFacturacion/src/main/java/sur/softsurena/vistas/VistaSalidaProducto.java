...
public final class VistaSalidaProducto extends javax.swing.JDialog {

    private static final long serialVersionUID = 1L;

    public VistaSalidaProducto(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//        Datos.getProductoById(null, txtCodigo.getText().trim())
    ...
    private void btnBuscarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarProductoActionPerformed
        VistaBusquedaProducto miBusqueda = new VistaBusquedaProducto(
                null, true
        );
