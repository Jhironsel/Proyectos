 ...
 * @author jhironsel
 */
public final class VistaCategorias extends javax.swing.JDialog {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        VistaCategoriasAdmin miCategoria = new VistaCategoriasAdmin(
                null, nombreCategoria, estado, false
        );
    ...
    private void cbCategoriaPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_cbCategoriaPopupMenuWillBecomeInvisible
        ...
        var fotos = M_Foto_Categoria.select(
                FotoCategoria
                        .builder()
                        .id(((Categoria) cbCategoria.getSelectedItem()).getId_categoria())
                        .build()
        );
