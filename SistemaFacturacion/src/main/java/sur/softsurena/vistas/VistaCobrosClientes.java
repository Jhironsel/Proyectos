...
public final class VistaCobrosClientes extends javax.swing.JDialog {
    ...
    public VistaCobrosClientes(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                getIdTurno());
    ...
    private void btnBuscarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarClienteActionPerformed
        VistaBusquedaPersona miBusqueda = new VistaBusquedaPersona(
                null, true, new String[]{"Todos", "Clientes"}
        );
        miBusqueda.setLocationRelativeTo(null);
        miBusqueda.setVisible(true);

        Persona persona = miBusqueda.getPersona();
