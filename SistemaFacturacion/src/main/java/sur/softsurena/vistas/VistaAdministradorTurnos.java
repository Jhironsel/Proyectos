...
/**
 * Formulario para la administración de turnos de los cajeros.
 * Permite abrir y cerrar turnos, así como generar reportes de los mismos.
 * <p>
 * Este formulario es un singleton, lo que significa que solo puede haber una
 * instancia de él en la aplicación.
 * <p>
 * Este formulario es parte del sistema de facturación desarrollado por
 * SoftSurena, una empresa dedicada al desarrollo de software para la gestión
 * empresarial.
 * <p>
 * @author jhironsel
 * @version 1.0
 * @since 2024-11-24
 */
public final class VistaAdministradorTurnos extends javax.swing.JInternalFrame {

    private static final long serialVersionUID = 1L;

    public VistaAdministradorTurnos() {
        initComponents();
    }
