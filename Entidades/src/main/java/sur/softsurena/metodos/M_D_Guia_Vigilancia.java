...
public class M_D_Guia_Vigilancia {
     ...
     * @return
     */
    public synchronized static Resultado insert(D_Guia_Vigilancia detalle) {
        ...
        try (PreparedStatement ps = getCnn().prepareStatement(
            ...
            ps.setInt(1, detalle.getGvd().getId());
            ps.setInt(2, detalle.getPaciente().getPersona().getId_persona());
     ...
     * @return
     */
    public synchronized static Resultado update(D_Guia_Vigilancia detalle) {
        ...
        try (CallableStatement ps = getCnn().prepareCall(
            ...
            ps.setInt(2, detalle.getGvd().getId());
            ps.setInt(3, detalle.getPaciente().getPersona().getId_persona());
    ...
    public synchronized static Resultado delete(
            @NonNull D_Guia_Vigilancia detalle
    ){
        try (CallableStatement ps = getCnn().prepareCall(
