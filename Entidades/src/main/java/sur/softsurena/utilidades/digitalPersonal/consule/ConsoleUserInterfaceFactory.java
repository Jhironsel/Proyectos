...
/**
 * Implementation of UserInterface.Factory interface that creates a
...
public class ConsoleUserInterfaceFactory implements UserInterface.Factory {
    ...
    private static class ConsoleUserInterface
        ...
        /**
         * register() looks for the user in the database, invokes
         * CreateRegistrationTemplate(), and stores the template in the
         * database.
         *
        ...
        /**
         * Acquires fingerprint from the sensor and matches it with the
         * registration templates stored in the database.
         *
