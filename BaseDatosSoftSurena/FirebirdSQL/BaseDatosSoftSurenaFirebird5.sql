...
CREATE DOMAIN D_BOOLEAN_T
 ...
 DEFAULT TRUE
;
CREATE DOMAIN D_CANTIDAD_PACIENTE
 AS SMALLINT
 DEFAULT 0
 CHECK (VALUE >= 0)
;
...
CREATE DOMAIN D_ESTADO_C_I_P_A_N_T
 ...
 COLLATE UTF8;
CREATE DOMAIN D_ESTADO_ENTRADA_PRODUCTO
 AS CHAR(1)
 DEFAULT 't'
 NOT NULL
...
SET TERM ^ ;
CREATE PROCEDURE SP_D_FOTO_CATEGORIA_BY_ID_CATEGORIA (
    ID_CATEGORIA D_ID )
SQL SECURITY DEFINER
AS 
BEGIN 
...
SET TERM ^ ;
CREATE PROCEDURE SP_D_M_ENTRADA_PRODUCTO (
    ID D_ID )
SQL SECURITY DEFINER
AS 
BEGIN 
...
SET TERM ^ ;
CREATE PROCEDURE SP_I_M_ENTRADA_PRODUCTO (
    ID_PROVEEDOR D_ID_DEFAULT_0,
    ID_ALMACEN D_ID_DEFAULT_0,
    COD_FACTURA D_CODIGO,
    ESTADO D_ESTADO_ENTRADA_PRODUCTO DEFAULT 't' )
RETURNS (
    ID D_ID )
SQL SECURITY DEFINER
AS 
...
SET TERM ^ ;
CREATE PROCEDURE SP_I_PERSONA_EMPLEADO_ATR (
    ID D_ID_MAYOR_0,
...
SET TERM ^ ;
CREATE PROCEDURE SP_UI_GENERAL (
    ID_PERSONA D_ID_DEFAULT_0,
    CEDULA D_CEDULA,
    ID_TIPO_SANGRE D_ID_DEFAULT_0,
    ESTADO_CIVIL D_ESTADO_CIVIL )
...
SET TERM ^ ;
CREATE PROCEDURE SP_U_M_ENTRADA_PRODUCTO (
    ID D_ID,
    ID_PROVEEDOR D_ID_DEFAULT_0,
    ID_ALMACEN D_ID_DEFAULT_0,
    COD_FACTURA D_CODIGO,
...
(
  ...
  CONSTRAINT PK_D_ENTRADA_PRODUCTOS_0 PRIMARY KEY (ID)
);
...
SELECT 
     ...
     g.CEDULA
FROM V_M_DEUDAS d
INNER JOIN V_PERSONAS p ON d.ID_CLIENTE = p.ID
LEFT JOIN V_GENERALES g ON d.ID_CLIENTE = g.ID_PERSONA;
CREATE VIEW GET_DIRECCION_BY_ID (ID, ID_PERSONA, ID_PROVINCIA, PROVINCIA, ID_MUNICIPIO, MUNICIPIO, ID_DISTRITO_MUNICIPAL, DISTRITO_MUNICIPAL, ID_CODIGO_POSTAL, 
    LOCALIDAD, CODIGO_POSTAL, DIRECCION, FECHA, ESTADO, POR_DEFECTO)
AS SELECT r.ID, r.ID_PERSONA, 
     r.ID_PROVINCIA, p.NOMBRE, 
     r.ID_MUNICIPIO, m.NOMBRE,
     r.ID_DISTRITO_MUNICIPAL, d.NOMBRE, 
     r.ID_CODIGO_POSTAL, c.LOCALIDAD, c.CODIGO_POSTAL,
     r.DIRECCION, r.FECHA, r.ESTADO, r.POR_DEFECTO
FROM V_CONTACTOS_DIRECCIONES r
INNER JOIN V_T_PROVINCIAS p ON p.ID = r.ID_PROVINCIA
INNER JOIN V_T_MUNICIPIOS m ON m.ID = r.ID_MUNICIPIO
INNER JOIN V_T_DISTRITOS_MUNICIPALES d ON d.ID = r.ID_DISTRITO_MUNICIPAL
INNER JOIN V_T_CODIGOS_POSTALES c ON c.ID = r.ID_CODIGO_POSTAL;
...
SELECT 
     ...
     p.PNOMBRE, p.SNOMBRE, p.APELLIDOS
FROM V_M_FACTURAS f
INNER JOIN V_PERSONAS p ON p.ID = f.ID_CLIENTE 
/*
...
SELECT 
     ...
     FECHA_HORA
FROM D_DEUDAS_PAGAS;
CREATE VIEW V_D_ENTRADA_PRODUCTOS (ID, LINEA, ID_M_ENTRADA_PRODUCTO, ID_ALMACEN, ID_PRODUCTO, ENTRADA, COSTO, FECHA_VECIMIENTO, OBSERVACION)
AS SELECT ID, LINEA, ID_M_ENTRADA_PRODUCTO, ID_ALMACEN, ID_PRODUCTO, ENTRADA, COSTO, 
...
CREATE VIEW V_D_RECETAS (ID, ID_RECETA, LINEA, ID_MEDICAMENTO, CANTIDAD, D_DOSIS)
AS /*
*/
SELECT 
    ID,
...
FROM FOTO_PRODUCTO;
CREATE VIEW V_GENERALES (ID_PERSONA, ID_TIPO_SANGRE, CEDULA, ESTADO_CIVIL)
AS /*
...
SELECT 
     ...
     ESTADO
FROM M_DEUDAS;
CREATE VIEW V_M_ENTRADA_PRODUCTOS (ID, ID_PROVEEDOR, ID_ALMACEN, COD_FACTURA, FECHA_ENTRADA, ESTADO, ROL, USER_NAME)
AS SELECT 
     ID,
     ID_PROVEEDOR,
     ID_ALMACEN,
...
*/;
CREATE VIEW V_PERSONAS_CLIENTES_GEN (ID, PERSONA, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, FECHA_NACIMIENTO, FECHA_INGRESO, FECHA_HORA_ULTIMO_UPDATE, ESTADO, 
    ID_TIPO_SANGRE, CEDULA, ESTADO_CIVIL, TOTAL_FACTURADO, TOTAL_DEUDA, CANTIDAD_FACTURA, FECHA_ULTIMA_COMPRA)
AS SELECT c.ID, 
        p.PERSONA, p.PNOMBRE, p.SNOMBRE, p.APELLIDOS, p.SEXO, p.FECHA_NACIMIENTO, p.FECHA_INGRESO, 
        p.FECHA_HORA_ULTIMO_UPDATE, p.ESTADO, 
        COALESCE(g.ID_TIPO_SANGRE, 0) ID_TIPO_SANGRE, COALESCE(g.CEDULA, '000-0000000-0') CEDULA,
        COALESCE(g.ESTADO_CIVIL, 'X') ESTADO_CIVIL,
        COALESCE(a.TOTAL_FACTURADO, 0) TOTAL_FACTURADO, COALESCE(a.TOTAL_DEUDA, 0) TOTAL_DEUDA, 
        COALESCE(a.CANTIDAD_FACTURA, 0) CANTIDAD_FACTURA, COALESCE(a.FECHA_ULTIMA_COMPRA, '01.01.2000') FECHA_ULTIMA_COMPRA
FROM V_PERSONAS_CLIENTES c
INNER JOIN V_PERSONAS p ON c.ID = p.ID
LEFT join V_PERSONAS_CLIENTES_ATR a ON c.ID = a.ID
...
CREATE VIEW V_PERSONAS_EMPLEADOS_GEN (ID, PERSONA, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, FECHA_NACIMIENTO, FECHA_INGRESO, FECHA_HORA_ULTIMO_UPDATE, ESTADO, 
    ID_TIPO_SANGRE, CEDULA, ESTADO_CIVIL, ID_CARGO, SUELDO_BRUTO)
AS SELECT c.ID, 
        p.PERSONA, p.PNOMBRE, p.SNOMBRE, p.APELLIDOS, p.SEXO, p.FECHA_NACIMIENTO, p.FECHA_INGRESO, 
        p.FECHA_HORA_ULTIMO_UPDATE, p.ESTADO, 
        g.ID_TIPO_SANGRE, g.CEDULA, g.ESTADO_CIVIL,
        a.ID_CARGO, a.SUELDO_BRUTO
FROM V_PERSONAS_EMPLEADOS c
INNER JOIN V_PERSONAS p ON c.ID = p.ID
LEFT JOIN V_GENERALES g ON c.ID = g.ID_PERSONA
LEFT join V_PERSONAS_EMPLEADOS_ATR a ON c.ID = a.ID;
...
*/;
CREATE VIEW V_PERSONAS_ESTUDIANTES_GEN (ID, PERSONA, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, FECHA_NACIMIENTO, FECHA_INGRESO, FECHA_HORA_ULTIMO_UPDATE, ESTADO, 
    ID_TIPO_SANGRE, CEDULA, ESTADO_CIVIL, MATRICULA)
AS SELECT c.ID, 
        p.PERSONA, p.PNOMBRE, p.SNOMBRE, p.APELLIDOS, p.SEXO, p.FECHA_NACIMIENTO, p.FECHA_INGRESO, 
        p.FECHA_HORA_ULTIMO_UPDATE, p.ESTADO, 
        g.ID_TIPO_SANGRE, g.CEDULA, g.ESTADO_CIVIL,
        a.MATRICULA
FROM V_PERSONAS_ESTUDIANTES c
INNER JOIN V_PERSONAS p ON c.ID = p.ID
LEFT JOIN V_GENERALES g ON c.ID = g.ID_PERSONA
LEFT JOIN V_PERSONAS_ESTUDIANTES_ATR a ON c.ID = a.ID;
...
*/;
CREATE VIEW V_PERSONAS_PACIENTES_GEN (ID, PERSONA, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, FECHA_NACIMIENTO, FECHA_INGRESO, FECHA_HORA_ULTIMO_UPDATE, ESTADO, 
    ID_TIPO_SANGRE, CEDULA, ESTADO_CIVIL, CESAREA, TIEMPO_GESTACION, FUMADOR)
AS SELECT c.ID, 
        p.PERSONA, p.PNOMBRE, p.SNOMBRE, p.APELLIDOS, p.SEXO, p.FECHA_NACIMIENTO, p.FECHA_INGRESO, 
        p.FECHA_HORA_ULTIMO_UPDATE, p.ESTADO, 
        COALESCE(g.ID_TIPO_SANGRE, 0) ID_TIPO_SANGRE, COALESCE(g.CEDULA, '000-0000000-0') CEDULA, COALESCE(g.ESTADO_CIVIL, 'X'),
        COALESCE(a.CESAREA, FALSE) CESAREA, COALESCE(a.TIEMPO_GESTACION, 0) TIEMPO_GESTACION, COALESCE(a.FUMADOR, FALSE) FUMADOR
FROM V_PERSONAS_PACIENTES c
INNER JOIN V_PERSONAS p ON c.ID = p.ID
LEFT JOIN V_GENERALES g ON c.ID = g.ID_PERSONA
LEFT join V_PERSONAS_PACIENTES_ATR a ON c.ID = a.ID;
...
CREATE VIEW V_PERSONAS_PADRES_GEN (ID, PERSONA, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, FECHA_NACIMIENTO, FECHA_INGRESO, FECHA_HORA_ULTIMO_UPDATE, ESTADO, 
    ID_TIPO_SANGRE, CEDULA, ESTADO_CIVIL)
AS SELECT c.ID, 
        p.PERSONA, p.PNOMBRE, p.SNOMBRE, p.APELLIDOS, p.SEXO, p.FECHA_NACIMIENTO, p.FECHA_INGRESO, 
        p.FECHA_HORA_ULTIMO_UPDATE, p.ESTADO, 
        g.ID_TIPO_SANGRE, g.CEDULA, g.ESTADO_CIVIL
FROM V_PERSONAS_PADRES c
INNER JOIN V_PERSONAS p ON c.ID = p.ID
LEFT JOIN V_GENERALES g ON c.ID = g.ID_PERSONA;
...
CREATE VIEW V_PERSONAS_PROVEEDORES_GEN (ID, PERSONA, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, FECHA_NACIMIENTO, FECHA_INGRESO, FECHA_HORA_ULTIMO_UPDATE, ESTADO, 
    ID_TIPO_SANGRE, CEDULA, ESTADO_CIVIL, CODIGO)
AS SELECT c.ID, 
        p.PERSONA, p.PNOMBRE, p.SNOMBRE, p.APELLIDOS, p.SEXO, p.FECHA_NACIMIENTO, p.FECHA_INGRESO, 
        p.FECHA_HORA_ULTIMO_UPDATE, p.ESTADO, 
        g.ID_TIPO_SANGRE, g.CEDULA, g.ESTADO_CIVIL,
        a.CODIGO
FROM V_PERSONAS_PROVEEDORES c
INNER JOIN V_PERSONAS p ON c.ID = p.ID
LEFT JOIN V_GENERALES g ON c.ID = g.ID_PERSONA
LEFT join V_PERSONAS_PROVEEDORES_ATR a ON c.ID = a.ID;
CREATE VIEW V_PRECIOS (ID, ID_PRODUCTO, ID_TIPO_PRECIO, ID_TIPO_IMPUESTO, PRECIO, MONEDA, FECHA_INICIO, FECHA_FIN, DESCUENTO, COSTO_ENVIO, ESTADO)
AS SELECT 
    ID, 
    ID_PRODUCTO, 
    ID_TIPO_PRECIO, 
...
'El Almacen no existe en el sistema.';
...
'La categoria se encuentra inactiva. ID = [@1]';
CREATE EXCEPTION E_CATEGORIA_GENERICA
'La categoria generica no puede ser tocada';
CREATE EXCEPTION E_CATEGORIA_NO_EXISTE
'Categoria no encontrada en el sistema. ID = [@1]';
...
'Persona inactivo.';
CREATE EXCEPTION E_PERSONA_NO_ENCONTRADO
'Identificador de la persona no encontrado.';
...
CREATE EXCEPTION E_REGISTRO_GENERICO
'No puede realizar operaciones en este registro.';
...
BEGIN
    ...
    FOR SELECT ID FROM V_M_ENTRADA_PRODUCTOS WHERE ID > :ID INTO v_id DO BEGIN
        EXECUTE PROCEDURE SP_D_M_ENTRADA_PRODUCTO(:v_id);
    END
    ...
    FOR SELECT ID FROM V_CONSULTAS WHERE ID > :ID INTO v_id DO BEGIN
    ...
    FOR SELECT ID FROM V_ALMACENES WHERE ID > :ID INTO v_id DO BEGIN
        EXECUTE PROCEDURE SP_D_ALMACEN(:v_id);
    END

    FOR SELECT ID_PERSONA FROM V_ASEGURADOS WHERE ID_PERSONA > :ID INTO v_id DO BEGIN
        EXECUTE PROCEDURE SP_D_ASEGURADO(:v_id);
    END
    
    FOR SELECT ID FROM V_ARS WHERE ID > :ID INTO v_id DO BEGIN
    ...
    FOR SELECT ID_PERSONA FROM V_GENERALES WHERE ID_PERSONA > :ID  INTO v_id DO BEGIN
    ...
    FOR SELECT ID FROM V_CATEGORIAS WHERE ID > :ID INTO v_id DO BEGIN
    ...
    FOR SELECT ID FROM V_PERSONAS_CLIENTES WHERE ID > :id INTO v_id DO BEGIN
        EXECUTE PROCEDURE SP_D_PERSONA_CLIENTE(:v_id);
    END
    
    FOR SELECT ID FROM V_PERSONAS_CLIENTES_ATR WHERE ID > :id INTO v_id DO BEGIN
    ...
    FOR SELECT ID FROM V_PERSONAS WHERE ID > :id INTO v_id DO BEGIN
...
BEGIN
    ...
    POST_EVENT 'EVENT_ALMACEN '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_ASEGURADO '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
  ...
  POST_EVENT 'EVENT_CARGO '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
     ...
     */
     ...
     POST_EVENT 'EVENT_CARTON_BINGO '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
AS
BEGIN
    EXECUTE PROCEDURE SP_V_CATEGORIA(:ID);

    DELETE FROM V_CATEGORIAS WHERE ID = :ID;
    POST_EVENT 'EVENT_CATEGORIA '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    */
    ...
    POST_EVENT 'EVENT_CONSULTA '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_DIRECCION '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_CORREO '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_TELEFONO '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_CONTROL_CONSULTA '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    WHERE
        ID = :ID;
    POST_EVENT 'EVENT_DEPARTAMENTO '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_D_ANALISIS '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_D_DEUDAS_PAGAS '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_D_FACTURAS '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    EXECUTE PROCEDURE SP_V_CATEGORIA (:ID_CATEGORIA);
...
SET TERM ^ ;
ALTER PROCEDURE SP_D_FOTO_CATEGORIA_BY_ID_CATEGORIA (
...
BEGIN
    ...
    EXECUTE PROCEDURE SP_V_PERSONA (:ID_PERSONA);
...
BEGIN
    ...
    POST_EVENT 'EVENT_CEDULA '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_HORARIO '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_HUELLA '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_METRICA '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    POST_EVENT 'EVENT_M_DEUDA '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
SET TERM ^ ;
ALTER PROCEDURE SP_D_M_ENTRADA_PRODUCTO (
...
BEGIN
    ...
    POST_EVENT 'EVENT_M_FACTURA '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
ALTER PROCEDURE SP_D_PERSONA (
    ID TYPE OF COLUMN V_PERSONAS.ID )
SQL SECURITY DEFINER
...
BEGIN
     ...
     POST_EVENT 'EVENT_PERSONA '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
ALTER PROCEDURE SP_D_PERSONA_CLIENTE (
    ID TYPE OF COLUMN V_PERSONAS_CLIENTES.ID )
SQL SECURITY DEFINER
...
ALTER PROCEDURE SP_D_PERSONA_CLIENTE_ATR (
    ID TYPE OF COLUMN V_PERSONAS_CLIENTES_ATR.ID )
SQL SECURITY DEFINER
...
ALTER PROCEDURE SP_D_PERSONA_EMPLEADO (
    ID TYPE OF COLUMN V_PERSONAS_EMPLEADOS.ID )
SQL SECURITY DEFINER
...
ALTER PROCEDURE SP_D_PERSONA_PACIENTE_ATR (
    ID TYPE OF COLUMN V_PERSONAS_PACIENTES_ATR.ID )
SQL SECURITY DEFINER
...
BEGIN
    ...
    POST_EVENT 'EVENT_PRECIO '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
     ...
     */
     ...
     POST_EVENT 'EVENT_PRODUCTO '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
     ...
     */
     ...
     POST_EVENT 'EVENT_USUARIO '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
BEGIN
    ...
    */
    ...
    IF(:ID_TURNO > 0)THEN BEGIN
        IF(EXISTS(SELECT 1 FROM V_TURNOS t WHERE t.ID = :ID_TURNO AND t.ESTADO IS FALSE))THEN BEGIN
            EXCEPTION E_TURNO_CERRADO;
        END
    END
    
    --2
    IF(NOT EXISTS(SELECT 1 FROM GET_CAJEROS WHERE TRIM(USER_NAME) LIKE TRIM(:USER_NAME)))THEN
        EXCEPTION E_CAJERO_NO_REGISTRADO;
    
    --3
    EXECUTE PROCEDURE SP_V_ALMACEN (:ID_ALMACEN);
                
    IF(EXISTS(SELECT 1 FROM V_ALMACENES WHERE ID = :ID_ALMACEN AND BORRADO))THEN
...
BEGIN
    ...
    IF(NOT EXISTS(SELECT 1 FROM V_PERSONAS_PACIENTES WHERE ID = :ID_PACIENTE))THEN
            EXCEPTION E_PERSONA_NO_ENCONTRADO;
...
ALTER PROCEDURE SP_I_CONTACTO_TEL (
    ID_PERSONA TYPE OF COLUMN CONTACTOS_TEL.ID_PERSONA,
...
RETURNS (
    O_ID TYPE OF COLUMN CONTACTOS_TEL.ID )
SQL SECURITY DEFINER

AS
BEGIN
    --Se valida el id de la persona que este registrado en la tabla persona.
    IF(NOT EXISTS(SELECT 1 FROM V_PERSONAS WHERE ID = :ID_PERSONA))THEN 
        EXCEPTION E_CLIENTE_NO_ENCONTRADO;
        
    EXECUTE PROCEDURE SP_V_PERSONA (:ID_PERSONA);
    
    --Se valida que id de la persona y el telefono no este duplicado.
    IF(EXISTS(SELECT 1 FROM V_CONTACTOS_TEL WHERE ID_PERSONA = :ID_PERSONA AND TELEFONO STARTING WITH :TELEFONO))THEN
        EXCEPTION E_CONTACTO_TEL_DUPLICADO USING (:ID_PERSONA);
    ...
    VALUES(NULL, :ID_PERSONA, :TELEFONO, :TIPO, :POR_DEFECTO)
    RETURNING(ID)
    INTO O_ID;
...
BEGIN
    ...
    VALUES (:ID_PERSONA, :CEDULA, :ID_TIPO_SANGRE, :ESTADO_CIVIL);
...
BEGIN
    --Se valida que no exista un nombre de almacen duplicado.
    EXECUTE PROCEDURE SP_V_PERSONA (:ID_CLIENTE);
    ...
    POST_EVENT 'EVENT_DEUDA '||TRIM(CURRENT_USER);
    SUSPEND;
END
^
SET TERM ; ^
...
SET TERM ^ ;
ALTER PROCEDURE SP_I_M_ENTRADA_PRODUCTO (
...
BEGIN
    ...
    EXECUTE PROCEDURE SP_V_PERSONA (:ID_PROVEEDOR);
...
SET TERM ^ ;
ALTER PROCEDURE SP_I_PERSONA_EMPLEADO_ATR (
    ID TYPE OF COLUMN PERSONAS_EMPLEADOS_ATR.ID,
...
BEGIN
    ...
    INSERT INTO PERSONAS_EMPLEADOS_ATR (ID, ID_CARGO, SUELDO_BRUTO)
    VALUES (
        :ID,
        :ID_CARGO, 
        :SUELDO_BRUTO
...
SET TERM ^ ;
ALTER PROCEDURE SP_U_M_ENTRADA_PRODUCTO (
    ID TYPE OF COLUMN M_ENTRADA_PRODUCTOS.ID,
    ID_PROVEEDOR TYPE OF COLUMN M_ENTRADA_PRODUCTOS.ID_PROVEEDOR,
    ID_ALMACEN TYPE OF COLUMN M_ENTRADA_PRODUCTOS.ID_ALMACEN,
    COD_FACTURA TYPE OF COLUMN M_ENTRADA_PRODUCTOS.COD_FACTURA,
...
BEGIN
    ...
    POST_EVENT 'EVENT_EMPLEADO '||TRIM(CURRENT_USER);
END
^
SET TERM ; ^
...
SET TERM ^ ;
ALTER PROCEDURE SP_V_ALMACEN (
    ID_ALMACEN TYPE OF COLUMN ALMACENES.ID )
SQL SECURITY DEFINER
...
SET TERM ^ ;
ALTER PROCEDURE SP_V_CATEGORIA (
    ID_CATEGORIA TYPE OF COLUMN CATEGORIAS.ID )
SQL SECURITY DEFINER
...
BEGIN
    ...
    IF(NOT EXISTS(SELECT 1 FROM V_CATEGORIAS WHERE ID = :ID_CATEGORIA))THEN
        EXCEPTION E_CATEGORIA_NO_EXISTE USING (:ID_CATEGORIA);
    
    IF(EXISTS(SELECT 1 FROM V_CATEGORIAS WHERE ID = :ID_CATEGORIA AND ESTADO IS FALSE))THEN
        EXCEPTION E_CATEGORIAS_INACTIVA USING (:ID_CATEGORIA);
END
^
SET TERM ; ^
...
BEGIN 
    ...
    IF(EXISTS(SELECT 1 FROM V_PERSONAS WHERE ID = :ID_PERSONA AND ESTADO IS FALSE))THEN
...
COMMENT ON COLUMN ALMACENES.ID IS 'Identificador de los registros.';
COMMENT ON COLUMN ALMACENES.NOMBRE IS 'Nombre del Almacen.';
COMMENT ON COLUMN ALMACENES.UBICACION IS 'Descripcion de la ubicacion del almacen.';
COMMENT ON COLUMN ALMACENES.ESTADO IS 'Estado del almacen';
...
ALTER TABLE D_ENTRADA_PRODUCTOS ADD CONSTRAINT FK_D_ENTRADA_PRODUCTOS_0
  FOREIGN KEY (ID_M_ENTRADA_PRODUCTO) REFERENCES M_ENTRADA_PRODUCTOS (ID);
ALTER TABLE D_ENTRADA_PRODUCTOS ADD CONSTRAINT FK_D_ENTRADA_PRODUCTOS_1
  FOREIGN KEY (ID_PRODUCTO) REFERENCES PRODUCTOS (ID);
ALTER TABLE D_ENTRADA_PRODUCTOS ADD CONSTRAINT FK_D_ENTRADA_PRODUCTOS_2
  FOREIGN KEY (ID_ALMACEN) REFERENCES ALMACENES (ID);
...
GRANT R_CLIENTE TO SYSDBA WITH ADMIN OPTION GRANTED BY SYSDBA;
GRANT EXECUTE
...
GRANT EXECUTE
 ON PROCEDURE SP_D_FOTO_CATEGORIA_BY_ID_CATEGORIA TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_D_FOTO_CATEGORIA_BY_ID_CATEGORIA TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_D_M_ENTRADA_PRODUCTO TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_I_M_ENTRADA_PRODUCTO TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_I_PERSONA_EMPLEADO_ATR TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_PERSONA_EMPLEADO_ATR TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_UI_GENERAL TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_U_M_ENTRADA_PRODUCTO TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_U_TURNO TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_U_TURNO TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_V_ALMACEN TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_V_CATEGORIA TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_V_PERSONA TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON D_ENTRADA_PRODUCTOS TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON D_ENTRADA_PRODUCTOS TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_D_ENTRADA_PRODUCTOS TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA;
...
GRANT SELECT
 ON V_FOTO_CATEGORIA TO ROLE R_CAJERO GRANTED BY SYSDBA;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_PERSONAS_CLIENTES_GEN TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_PERSONAS_EMPLEADOS_GEN TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_PERSONAS_ESTUDIANTES_GEN TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_PERSONAS_PACIENTES_GEN TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_PERSONAS_PADRES_GEN TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_PERSONAS_PROVEEDORES_GEN TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA;
