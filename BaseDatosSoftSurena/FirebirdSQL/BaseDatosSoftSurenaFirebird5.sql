...
CREATE VIEW GET_CAJEROS (USER_NAME, ROL, PNOMBRE, SNOMBRE, APELLIDOS, ESTADO, 
    DESCRIPCION)
AS /*
...
CREATE VIEW GET_DEUDAS (ID, ID_CLIENTE, CONCEPTO, MONTO, FECHA, HORA, ESTADO, 
    P_NOMBRE, S_NOMBRE, APELLIDOS, CEDULA)
AS /*
...
CREATE VIEW GET_DIRECCION_BY_ID (ID, ID_PERSONA, ID_PROVINCIA, PROVINCIA, 
    ...
    ID_CODIGO_POSTAL, CODIGO_POSTAL, DIRECCION, FECHA, ESTADO, POR_DEFECTO)
...
CREATE VIEW GET_D_FACTURAS (ID, LINEA, ID_FACTURA, ID_PRODUCTO, ID_PRECIO, 
...
CREATE VIEW GET_ESTUDIANTES_SV (ID, MATRICULA, CEDULA, PNOMBRE, SNOMBRE, 
    APELLIDOS, SEXO, FECHA_NACIMIENTO, ESTADO)
AS --
SELECT 
     r.ID, 
     e.MATRICULA, 
...
CREATE VIEW GET_M_FACTURAS (ID, ID_CLIENTE, ID_CONTACTOS_TEL, 
    ID_CONTACTOS_DIRECCIONES, ID_CONTACTOS_EMAIL, ID_TURNO, FECHA_HORA, 
    ESTADO_FACTURA, NOMBRE_TEMP, USER_NAME, PNOMBRE, SNOMBRE, APELLIDOS)
AS /*
...
*/;
CREATE VIEW GET_PADRES (ID, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, 
    FECHA_NACIMIENTO, ESTADO_PERSONA, ID_TIPO_SANGREE, CEDULA, ESTADO_CIVIL, 
    ID_ARS, NO_NSS, ESTADO_SEGURO)
AS SELECT 
 ...
 */;
CREATE VIEW GET_PERMISOS_ASIGNADOS (USUARIO, GRANT_OPTION, ID_TIPO_OBJ, 
...
CREATE VIEW GET_PERSONAS_PADRES (ID, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, 
    FECHA_NACIMIENTO, ESTADO_PERSONA, ID_TIPO_SANGREE, CEDULA, ESTADO_CIVIL, 
    ID_ARS, NO_NSS, ESTADO_SEGURO)
AS SELECT 
    persona.ID, persona.PNOMBRE, persona.SNOMBRE, persona.APELLIDOS, 
...
/*
    Por el momento tenemos estos datos.
 */;
CREATE VIEW GET_PERSONA_CLIENTES (ID, CEDULA, PERSONA, PNOMBRE, SNOMBRE, 
    APELLIDOS, SEXO, FECHA_NACIMIENTO, ESTADO_CIVIL, FECHA_INGRESO, ESTADO)
AS /*
...
CREATE VIEW GET_PROVEEDORES (ID, PERSONA, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, 
...
CREATE VIEW GET_TABLA_VISTA_SYSTEMA (NOMBRE, SQL_SEGURIDAD, TIPO_RELACION, 
    DESCRIPCION)
AS SELECT 
    RDB$RELATION_NAME, 
    RDB$SQL_SECURITY, 
...
FROM V_TANDAS t;
CREATE VIEW GET_TURNOS (ID, TURNO_USUARIO, FECHA_HORA_INICIO, FECHA_HORA_FINAL, 
...
CREATE VIEW VS_PRIVILEGIO (USUARIO, GRANTOR, ABRV_PRIVILEGIO, NOMBRE_ABREV, 
    GRANT_OPTION, CON_OPC_ADMIN, NOMBRE_RELACION, NOMBRE_CAMPO, 
    ID_TIPO_USUARIO, TIPO_USUARIO, ID_TIPO_OBJ, TIPO_OBJ, DESCRIPCION)
AS /*
...
*/;
CREATE VIEW VS_PROCEDIMIENTOS (ID, PROCEDIMIENTO, PROPIETARIO, SQL_SECURITY, 
    DESCRIPCION)
AS /*
...
FROM RDB$PROCEDURES;
CREATE VIEW VS_TRANSACCION_ACTUAL (TNIDENTIFICADORTRANSACCION, 
...
CREATE VIEW VS_USUARIOS (USERNAME, PNOMBRE, SNOMBRE, APELLIDOS, ESTADO, 
...
SELECT 
     ...
     DESCRIPCION
FROM ANTECEDENTES;
CREATE VIEW V_ARS (ID, DESCRIPCION, COVERTURA_CONSULTA_PORCIENTO, ESTADO, 
    CANTIDAD_REGISTRO, USER_NAME, ROL)
AS /*
...
FROM CARGOS r;
CREATE VIEW V_CARTONES_BINGO (ID, CARTON_HASH, FECHA_CREACCION, MATRIZ_OBJ, 
    ESTADO)
AS /*
...
AS SELECT 
    ...
    USER_NAME
FROM CATEGORIAS;
CREATE VIEW V_CONSULTAS (ID, ID_CONTROL_CONSULTA, FECHA, LINEA, ID_PACIENTE, 
    ESTADO, USER_NAME)
AS /*
...
CREATE VIEW V_CONTACTOS_DIRECCIONES (ID, ID_PERSONA, ID_PROVINCIA, 
    ID_MUNICIPIO, ID_DISTRITO_MUNICIPAL, ID_CODIGO_POSTAL, DIRECCION, FECHA, 
    ESTADO, POR_DEFECTO)
AS /*
...
CREATE VIEW V_CONTACTOS_TEL (ID, ID_PERSONA, TELEFONO, TIPO, FECHA, ESTADO, 
    POR_DEFECTO)
AS /*
...
SELECT 
     ...
     FECHA_HORA
FROM D_DEUDAS_PAGAS;
CREATE VIEW V_D_ENTRADA_PRODUCTO (ID, ID_M_ENTRADA_PRODUCTO, LINEA, 
    ID_PRODUCTO, ENTRADA, COSTO, FECHA_VECIMIENTO, OBSERVACION)
AS /*
...
CREATE VIEW V_D_FACTURAS (ID, LINEA, ID_FACTURA, ID_PRODUCTO, ID_PRECIO, 
    CANTIDAD)
AS /*
...
CREATE VIEW V_D_RECETAS (ID, ID_RECETA, LINEA, ID_MEDICAMENTO, ID_PRECIO, 
    CANTIDAD, D_DOSIS)
AS /*
*/
SELECT 
...
AS SELECT 
    ...
    ERR_COMENT
FROM ERRORES;
CREATE VIEW V_FOTO_CATEGORIA (ID, ID_CATEGORIA, FOTO, FECHA_HORA_CREACION, 
    ACTUAL)
...
SELECT 
     ...
     HUELLA
FROM HUELLAS;
CREATE VIEW V_INSCRIPCIONES (ID, ID_ESTUDIANTE, ID_TANDA, PAGO, 
    FECHA_INSCRIPCION, ROL, USER_NAME)
AS SELECT 
    ID, 
    ID_ESTUDIANTE, 
    ID_TANDA, 
...
SELECT 
     ...
     ESTADO
FROM MENSAJES;
CREATE VIEW V_METRICAS (ID, ID_CONSULTA, PESOKG, ESTATURAMETRO, ESCEFALO, 
    ENF_DETECT, HALLAZGOS_POS, ID_DIAG, TX, COMPLEMENTO, IMAGEN_TEXTO, USER_NAME
    )
AS /*
...
*/;
CREATE VIEW V_M_ANALISIS (ID, ID_PACIENTE, FECHA_HORA_CREADA, FECHA_HORA_VISTA, 
    ROL, USER_NAME)
AS /*
...
SELECT 
     ...
     ESTADO
FROM M_DEUDAS;
CREATE VIEW V_M_ENTRADA_PRODUCTOS (ID, ID_PROVEEDOR, ID_ALMACEN, COD_FACTURA, 
    FECHA_ENTRADA, ROL, USER_NAME)
AS SELECT 
     ID, 
     ID_PROVEEDOR, 
     ID_ALMACEN, 
...
CREATE VIEW V_M_FACTURAS (ID, ID_CLIENTE, ID_CONTACTOS_TEL, 
    ID_CONTACTOS_DIRECCIONES, ID_CONTACTOS_EMAIL, ID_TURNO, FECHA_HORA, 
...
CREATE VIEW V_PERSONAS_CLIENTES_ATR (ID, TOTAL_FACTURADO, TOTAL_DEUDA, 
    CANTIDAD_FACTURA, FECHA_ULTIMA_COMPRA, SALDO)
AS /*
...
CREATE VIEW V_PERSONAS_PACIENTES_ATR (ID, CESAREA, TIEMPO_GESTACION, FUMADOR, 
    USER_NAME)
AS /*
...
CREATE VIEW V_PRECIOS (ID, ID_PRODUCTO, ID_TIPO_PRECIO, ID_TIPO_IMPUESTO, 
...
AS SELECT 
    ...
    COSTO_ENVIO
FROM PRECIOS;
CREATE VIEW V_PRODUCTOS (ID, ID_CATEGORIA, CODIGO, DESCRIPCION, EXISTENCIA, 
    FECHA_CREACION, ESTADO, NOTA)
AS /*
     Inicio
*/
SELECT 
...
*/;
CREATE VIEW V_TURNOS (ID, TURNO_USUARIO, FECHA_HORA_INICIO, FECHA_HORA_FINAL, 
    ESTADO, MONTO_FACTURADO, MONTO_DEVUELTO, MONTO_EFECTIVO, MONTO_CREDITO, 
    ROL, USER_NAME)
AS SELECT 
     ID, 
...
CREATE VIEW V_T_E_S_SYS (ID, NOMBRE_EMPRESA, FCHI, FCHA, FCHV, DIAS_RESTANTES, 
    TELEFONO, DIRECCION, MENSAJE_FOOTER, PATH_LOGO, LOGO, USUARIO, CLAVE)
AS /*
...
SELECT 
     ...
     ID_PROVINCIA 
FROM T_MUNICIPIOS;
CREATE VIEW V_T_PLAN_CUENTA_CONTABLE (ID, PAIS, CODIGO_CUENTA_CONTABLE, 
    NOMBRE_CUENTA, TIPO_CUENTA, NIVEL_CUENTA, USA_TERCERO, CENTRO_COSTOS, 
    PORCENTAJE_BASE, MONTO_BASE_MIN, DETALLE_CUENTA)
AS /*
