...
CREATE SEQUENCE SEQ_GUIA_VIGILANCIA_DESARROLLO_ID START WITH 1 INCREMENT BY 1;
...
CREATE PROCEDURE SP_D_GENERAL (
    ID TYPE OF COLUMN GENERALES.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_U_DEUDA_ESTADO (
    ID_DEUDA TYPE OF COLUMN M_DEUDAS.ID,
    ESTADO_DEUDA TYPE OF COLUMN M_DEUDAS.ESTADO )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
(
  ID D_ID NOT NULL,
  ID_CONSULTA D_ID NOT NULL,
  ID_MOTIVO_CONSULTA D_ID NOT NULL,
...
(
  ID D_ID NOT NULL,
  ID_PRODUCTO D_ID NOT NULL,
  ID_TIPO_PRECIO D_ID NOT NULL,
  ID_TIPO_IMPUESTO D_ID NOT NULL,
...
CREATE VIEW GET_PROVEEDORES (ID, PERSONA, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, ESTADO, CEDULA, ID_PERSONA, ID_PROVINCIA, ID_MUNICIPIO, DIRECCION, CODIGO)
AS /*
...
FROM V_TURNOS r
FULL JOIN V_M_FACTURAS b ON b.ID_TURNO = r.ID
...
BEGIN
    ...
    DELETE FROM V_GENERALES WHERE ID = :ID;
...
DECLARE VARIABLE V_ESTADO TYPE OF COLUMN ALMACENES.ESTADO;
BEGIN
    --Consultamos el estado del amacen antes de actualizar.
     V_ESTADO = (SELECT ESTADO FROM V_ALMACENES WHERE ID = :ID);
...
BEGIN
    ...
    IF((SELECT DISTINCT (1) 
            FROM V_CATEGORIAS 
            WHERE DESCRIPCION LIKE :DESCRIPCION) = 1)THEN
...
SET TERM ^ ;
ALTER PROCEDURE SP_U_DEUDA_ESTADO (
    ID_DEUDA TYPE OF COLUMN M_DEUDAS.ID,
    ESTADO_DEUDA TYPE OF COLUMN M_DEUDAS.ESTADO )
SQL SECURITY DEFINER
...
ALTER TABLE ALMACENES_DISPONIBLE ADD CONSTRAINT FK_ALMACENES_DISPONIBLE_0
  FOREIGN KEY (ID_TURNO) REFERENCES TURNOS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ASEGURADOS ADD CONSTRAINT FK_ASEGURADOS_1
  FOREIGN KEY (ID_ARS) REFERENCES ARS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE CONSULTAS ADD CONSTRAINT FK_CONSULTAS_0
  FOREIGN KEY (ID_PACIENTE) REFERENCES PERSONAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
COMMENT ON TABLE CONSULTAS_APROBADAS IS 'AQUI SE ALMACEN LAS INFORMACIONES DE LA CONSULTAS 
ALMACENAS EN EL SISTEMA, QUE HAYAN SIDO APROVADAS.
';
...
ALTER TABLE CONTACTOS_DIRECCIONES ADD CONSTRAINT FK_CONTACTOS_DIRECCIONES_1
  FOREIGN KEY (ID_PROVINCIA) REFERENCES T_PROVINCIAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE CONTACTOS_DIRECCIONES ADD CONSTRAINT FK_CONTACTOS_DIRECCIONES_2
  FOREIGN KEY (ID_MUNICIPIO) REFERENCES T_MUNICIPIOS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE CONTACTOS_DIRECCIONES ADD CONSTRAINT FK_CONTACTOS_DIRECCIONES_3
  FOREIGN KEY (ID_DISTRITO_MUNICIPAL) REFERENCES T_DISTRITOS_MUNICIPALES (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE CONTACTOS_DIRECCIONES ADD CONSTRAINT FK_CONTACTOS_DIRECCIONES_4
  FOREIGN KEY (ID_CODIGO_POSTAL) REFERENCES T_CODIGOS_POSTALES (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE D_DEUDAS_PAGAS ADD CONSTRAINT FK_D_DEUDAS_PAGAS_0
  FOREIGN KEY (ID_DEUDAS) REFERENCES M_DEUDAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE D_FACTURAS ADD CONSTRAINT FK_D_FACTURAS_2
  FOREIGN KEY (ID_PRECIO) REFERENCES PRECIOS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE D_GUIA_VIGILANCIA_DESARROLLO ADD CONSTRAINT FK_D_GUIA_VIGILANCIA_DESARROLLO_0
  FOREIGN KEY (ID_PACIENTE) REFERENCES PERSONAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE D_GUIA_VIGILANCIA_DESARROLLO ADD CONSTRAINT FK_D_GUIA_VIGIL_DESAR_0
  FOREIGN KEY (ID_GVD) REFERENCES T_GUIA_VIGILANCIA_DESARROLLO (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE D_MOTIVO_CONSULTA ADD CONSTRAINT FK_D_MOTIVO_CONSULTA_1
  FOREIGN KEY (ID_MOTIVO_CONSULTA) REFERENCES T_MOTIVO_CONSULTA (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE D_RECETAS ADD CONSTRAINT FK_D_RECETAS_0
  FOREIGN KEY (ID_MEDICAMENTO) REFERENCES PRODUCTOS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE D_RECETAS ADD CONSTRAINT FK_D_RECETAS_1
  FOREIGN KEY (ID_RECETA) REFERENCES M_RECETAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE INSCRIPCIONES ADD CONSTRAINT FK_INSCRIPCIONES_0
  FOREIGN KEY (ID_ESTUDIANTE) REFERENCES PERSONAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE INSCRIPCIONES ADD CONSTRAINT FK_INSCRIPCIONES_1
  FOREIGN KEY (ID_TANDA) REFERENCES TANDAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE M_DEUDAS ADD CONSTRAINT FK_M_DEUDAS_0
  FOREIGN KEY (ID_CLIENTE) REFERENCES PERSONAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE M_ENTRADA_PRODUCTOS ADD CONSTRAINT FK_M_ENTRADA_PRODUCTOS_0
  FOREIGN KEY (ID_PROVEEDOR) REFERENCES PERSONAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE M_RECETAS ADD CONSTRAINT FK_M_RECETAS_1
  FOREIGN KEY (ID_CONSULTA) REFERENCES CONSULTAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE RELACION_PADRE_ESTUDIANTE ADD CONSTRAINT FK_RELACION_PADRE_ESTUDIANTE_0
  FOREIGN KEY (ID_PADRE_O_MADRE) REFERENCES PERSONAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
Debe:
   ...
   *';
ALTER TABLE T_CODIGOS_POSTALES ADD CONSTRAINT T_CODIGOS_POSTALES_FK
  FOREIGN KEY (ID_PROVINCIA) REFERENCES T_PROVINCIAS (ID);
CREATE INDEX T_CODIGO_POSTAL_IDX ON T_CODIGOS_POSTALES (CODIGO_POSTAL);
ALTER TABLE T_DISTRITOS_MUNICIPALES ADD CONSTRAINT ID_MUNICIPIO_IDX
...
GRANT EXECUTE
 ON PROCEDURE SP_U_DEUDA_ESTADO TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_U_DEUDA_ESTADO TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
