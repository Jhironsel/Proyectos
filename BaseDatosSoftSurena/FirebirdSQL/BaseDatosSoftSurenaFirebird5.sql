...
CREATE PROCEDURE SP_I_CATEGORIA (
    ...
    IMAGEN_TEXTO TYPE OF COLUMN V_CATEGORIAS.IMAGEN_TEXTO,
...
CREATE PROCEDURE SP_I_PRODUCTO (
    ...
    IMAGEN_TEXTO TYPE OF COLUMN V_PRODUCTOS.IMAGEN_TEXTO,
...
CREATE PROCEDURE SP_U_PRODUCTO (
    ...
    IMAGEN_TEXTO TYPE OF COLUMN PRODUCTOS.IMAGEN_TEXTO,
...
(
  ...
  CONSTRAINT INTEG_288 PRIMARY KEY (ID)
);
...
(
  ...
  CONSTRAINT INTEG_278 PRIMARY KEY (ID)
);
...
(
  ...
  CONSTRAINT INTEG_300 PRIMARY KEY (ID),
  CONSTRAINT INTEG_302 UNIQUE (NOMBRE)
);
...
(
  ...
  CONSTRAINT INTEG_242 PRIMARY KEY (RN_)
);
/********************* VIEWS **********************/
...
CREATE VIEW GET_PRODUCTOS (ID, ID_CATEGORIA, DESC_CATEGORIA, CODIGO, DESCRIPCION, EXISTENCIA, NOTA, FECHA_CREACION, ESTADO, IMAGEN_PRODUCTO, IMAGEN_CATEGORIA)
AS /*
...
CREATE VIEW VS_CATEGORIAS (ID, DESCRIPCION, FECHA_CREACION, ESTADO, USER_NAME, IMAGEN_TEXTO)
AS /*
...
SELECT 
     ...
     BORRADO
FROM ALMACENES;
CREATE VIEW V_ALMACENES_DISPONIBLE (ID, ID_TURNO, USER_NAME, ID_ALMACEN)
AS SELECT 
    ID, 
    ID_TURNO, 
    USER_NAME, 
...
SELECT 
     ...
     ESTADO
FROM MENSAJES;
CREATE VIEW V_METRICAS (ID, ID_CONSULTA, FECHA, PESOKG, ESTATURAMETRO, ESCEFALO, ENF_DETECT, HALLAZGOS_POS, ID_DIAG, TX, COMPLEMENTO, IMAGEN_TEXTO, USER_NAME)
AS /*
...
AS SELECT 
    ...
    COSTO_ENVIO
FROM PRECIOS;
CREATE VIEW V_PRODUCTOS (ID, ID_CATEGORIA, CODIGO, DESCRIPCION, EXISTENCIA, FECHA_CREACION, USER_NAME, ROL, ESTADO, NOTA, IMAGEN_TEXTO)
AS /*
     Inicio
*/
SELECT 
...
BEGIN 
     IF(I_OTORGAR)THEN BEGIN 
          ...
          EXECUTE STATEMENT V_SQL;
          V_SQL = 'GRANT SELECT ON GET_PERSONA_CLIENTES TO '||:I_ROL||(IIF(:I_CON_ADMIN,' WITH GRANT OPTION;', ';'));
          EXECUTE STATEMENT V_SQL;
          ...
          EXECUTE STATEMENT V_SQL;
          V_SQL = 'GRANT SELECT ON GET_M_FACTURAS TO '||:I_ROL||(IIF(:I_CON_ADMIN,' WITH GRANT OPTION;', ';'));
          EXECUTE STATEMENT V_SQL;
     ...
     END ELSE BEGIN 
          ...
          EXECUTE STATEMENT V_SQL;
          V_SQL = 'REVOKE '||(IIF(:I_CON_ADMIN,' GRANT OPTION FOR ', ''))||' SELECT ON GET_PERSONA_CLIENTES FROM '||:I_ROL;
          EXECUTE STATEMENT V_SQL;
          ...
          EXECUTE STATEMENT V_SQL;
          V_SQL = 'REVOKE '||(IIF(:I_CON_ADMIN,' GRANT OPTION FOR ', ''))||' SELECT ON GET_M_FACTURAS FROM '||:I_ROL;
          EXECUTE STATEMENT V_SQL;
...
BEGIN
     ...
     VALUES (NULL, :DESCRIPCION, :IMAGEN_TEXTO, :ESTADO)
     RETURNING ID
     INTO v_id;
...
BEGIN
    ...
    INSERT INTO FOTO_PERSONA (ID, ID_PERSONA, FOTO, ACTUAL)
...
BEGIN
     ...
     INSERT INTO V_PRODUCTOS (ID, ID_CATEGORIA, CODIGO, DESCRIPCION, IMAGEN_TEXTO, NOTA, ESTADO)
     VALUES (NULL, :ID_CATEGORIA, :CODIGO, :DESCRIPCION, :IMAGEN_TEXTO, :NOTA, :ESTADO)
     RETURNING ID 
     INTO O_ID;
...
BEGIN
     ...
     EXECUTE PROCEDURE SP_U_GENERAL (:ID, :CEDULA, :ID_TIPO_SANGRE, :ESTADO_CIVIL);
...
BEGIN
     /*
          TODO Crear validaciones para modificar un producto.
     */
...
BEGIN
     ...
     --Se actualiza en Personas Proveedor
     --TODO CREAR PROCEDIMIENTO SIGUIENTE LINEA.
     UPDATE V_PERSONAS_PROVEEDORES_ATR
     SET 
...
GRANT EXECUTE
 ON PROCEDURE SP_U_PADRE TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_U_PADRE TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT SELECT
 ON GET_CATEGORIA_ACTIVAS TO ROLE CAJERO GRANTED BY SYSDBA;
...
GRANT SELECT
 ON GET_PRODUCTOS TO ROLE CAJERO GRANTED BY SYSDBA;
...
GRANT SELECT
 ON VS_CATEGORIAS TO ROLE CAJERO GRANTED BY SYSDBA;
