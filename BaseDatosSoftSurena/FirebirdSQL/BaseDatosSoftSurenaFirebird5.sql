...
CREATE SEQUENCE SEQ_RECCOUNT_ID START WITH 1 INCREMENT BY 1;
...
CREATE PROCEDURE SP_D_ANTECEDENTE (
    I_ID TYPE OF COLUMN ANTECEDENTES.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_D_M_FACTURA (
    I_ID TYPE OF COLUMN M_FACTURAS.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_I_D_FACTURAS (
    ...
    ID_LINEA TYPE OF COLUMN D_FACTURAS.ID_LINEA,
...
CREATE PROCEDURE SP_I_ENTRADA_PRODUCTO (
    ID_PROVEEDOR TYPE OF COLUMN V_M_ENTRADA_PRODUCTOS.ID_PROVEDOR,
...
CREATE PROCEDURE SP_I_M_FACTURA (
    ...
    TOTAL TYPE OF COLUMN M_FACTURAS.TOTAL,
    EFECTIVO TYPE OF COLUMN M_FACTURAS.EFECTIVO,
...
CREATE PROCEDURE SP_I_PERSONA_PACIENTE (
    ID_PACIENTE TYPE OF COLUMN PERSONAS_PACIENTES_ATR.ID_PACIENTE,
...
CREATE PROCEDURE SP_I_TURNO (
    I_TURNO_USUARIO TYPE OF COLUMN V_TURNOS.TURNO_USUARIO )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_U_CONSULTAS (
    ...
    ID_PACIENTE TYPE OF COLUMN CONSULTAS.ID_PACIENTE,
    ID_CONTROL_CONSULTA TYPE OF COLUMN CONSULTAS.ID_CONTROL_CONSULTA,
    TURNO TYPE OF COLUMN CONSULTAS.TURNO,
...
CREATE PROCEDURE SP_U_PERSONA_PACIENTE (
    ID_PACIENTE TYPE OF COLUMN PERSONAS_PACIENTES.ID,
    PESO_NACIMIENTO_KG TYPE OF COLUMN PERSONAS_PACIENTES_ATR.PESO_NACIMIENTO_KG,
...
(
  ...
  NO_NSS D_VARCHAR_25,
  ESTADO D_BOOLEAN_T NOT NULL,
  CONSTRAINT PK_ASEGURADOS_0 PRIMARY KEY (ID_PERSONA,ID_ARS),
...
CREATE VIEW GET_D_FACTURAS (ID_FACTURA, ID_LINEA, ID_PRODUCTO, ID_PRECIO, DESCRIPCION, CANTIDAD)
AS /*
...
WHERE r.ID > 0 AND g.ID_PERSONA > 0;
...
AS SELECT m.ID, c.ID_PACIENTE, m.PESOKG, m.ESTATURAMETRO
FROM CONSULTAS c
INNER JOIN METRICAS m ON m.ID_CONSULTA = c.ID;
CREATE VIEW GET_M_FACTURAS (ID, ID_CLIENTE, ID_CONTACTOS_TEL, ID_CONTACTOS_DIRECCIONES, ID_CONTACTOS_EMAIL, ID_TURNO, FECHA_HORA, TOTAL, EFECTIVO, 
    ESTADO_FACTURA, NOMBRE_TEMP, USER_NAME, PNOMBRE, SNOMBRE, APELLIDOS)
AS /*

*/
SELECT 
     LPAD(f.ID, 7, 0), f.ID_CLIENTE, f.ID_CONTACTOS_TEL, f.ID_CONTACTOS_DIRECCIONES, f.ID_CONTACTOS_EMAIL, f.ID_TURNO, 
     f.FECHA_HORA, f.TOTAL, f.EFECTIVO, f.ESTADO_FACTURA, f.NOMBRE_TEMP, f.USER_NAME, 
     p.PNOMBRE, p.SNOMBRE, p.APELLIDOS
FROM V_M_FACTURAS f
...
SELECT 
     r.ID, 
     p.PNOMBRE, p.SNOMBRE, p.APELLIDOS, p.SEXO, p.FECHA_NACIMIENTO, p.FECHA_INGRESO, p.FECHA_HORA_ULTIMO_UPDATE, 
     p.ESTADO,
...
WHERE r.ID >= 0 AND p.ID >= 0 AND a.ID >= 0;
...
FROM V_TANDAS t;
CREATE VIEW GET_TURNOS (ID, ID_ALMACEN, TURNO_USUARIO, FECHA_HORA_INICIO, FECHA_HORA_FINAL, ESTADO, MONTO_FACTURADO, MONTO_DEVUELTO, MONTO_EFECTIVO, 
    MONTO_CREDITO, NOMBRE_ALMACEN, ID_FACTURA)
AS /*
...
FROM V_TURNOS r
LEFT JOIN V_ALMACENES a ON a.ID = r.ID_ALMACEN AND a.ESTADO 
LEFT JOIN V_M_FACTURAS b ON b.ID_TURNO = r.ID AND b.ESTADO_FACTURA = 'i';
...
AS SELECT ID, DESCRIPCION, FECHA_CREACION, ESTADO, USER_NAME, IMAGEN_TEXTO
FROM CATEGORIAS
WHERE ID >= 0;
...
WHERE ID >= 0;
CREATE VIEW V_D_FACTURAS (ID_FACTURA, ID_LINEA, ID_PRODUCTO, ID_PRECIO, CANTIDAD)
AS /*
...
WHERE ID>0 AND ID_GVD >= 0 AND ID_PACIENTE >= 0;
...
WHERE ID_CONSULTA >= 0 AND ID_MOTIVO_CONSULTA >= 0 AND ID >= 0;
...
AS SELECT ID, ERR_MODULO, ERR_USUARIO, ERR_TIEMPO, ERR_COMENT
FROM ERRORES;
...
WHERE ID >= 0;
CREATE VIEW V_M_FACTURAS (ID, ID_CLIENTE, ID_CONTACTOS_TEL, ID_CONTACTOS_DIRECCIONES, ID_CONTACTOS_EMAIL, ID_TURNO, FECHA_HORA, TOTAL, EFECTIVO, 
...
SELECT 
     ...
     ROL_USUARIO
FROM PERSONAS 
WHERE ID >= -1 OR ID IS NULL AND SEXO IN('X','M','F')
--WITH CHECK OPTION
/*
...
AS SELECT ID, ID_PRODUCTO, ID_TIPO_PRECIO, ID_TIPO_IMPUESTO, PRECIO, MONEDA, FECHA_INICIO, FECHA_FIN, 
...
*/;
CREATE VIEW V_TURNOS (ID, ID_ALMACEN, TURNO_USUARIO, FECHA_HORA_INICIO, FECHA_HORA_FINAL, ESTADO, MONTO_FACTURADO, MONTO_DEVUELTO, MONTO_EFECTIVO, 
    MONTO_CREDITO, ROL, USER_NAME)
AS SELECT 
     ID, 
     ID_ALMACEN, 
     TURNO_USUARIO, 
...
AS SELECT ID, NOMBRE, PORCENTAJE
FROM T_IMPUESTOS;
...
AS SELECT ID, NOMBRE, DESCRIPCION
FROM T_TIPOS_PRECIO;
...
BEGIN
     ...
     */
     ...
     VALUES (NULL, :ID, UPPER(:USER_NAME));
END
^
SET TERM ; ^
...
BEGIN
    ...
    FOR SELECT ID FROM V_GENERALES WHERE ID_PERSONA > :id  INTO v_id DO BEGIN
    ...
    FOR SELECT ID FROM V_PERSONAS WHERE ID > 0 INTO v_id DO BEGIN
...
BEGIN
     ...
     */
     ...
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_ANTECEDENTES');
...
BEGIN
     ...
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_ASEGURADOS', :v_estado);
     
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_ASEGURADOS');
...
BEGIN
     ...
     */
     ...
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_CARTONES_BINGO', :v_estado);
     
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_CARTONES_BINGO');
...
BEGIN
     ...
     */
     ...
     /*Guardamos cantidad de registros por estado*/
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_CONSULTAS', :v_estado);
     
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_CONSULTAS');
...
BEGIN
    ...
    EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_CONSULTAS_APROBADAS');
END
^
SET TERM ; ^
...
BEGIN
    ...
    EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D','V_CONTACTOS_DIRECCIONES', :v_estado);
    
    EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_CONTACTOS_DIRECCIONES');
...
BEGIN
   ...
   */
     ...
     /*Guardamos cantidad de registros por estado*/
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_CONTACTOS_EMAIL', :v_estado);
     
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_CONTACTOS_EMAIL');
...
BEGIN
   ...
   */
    v_estado = (SELECT ESTADO FROM V_CONTACTOS_TEL  WHERE ID = :ID);
     ...
     /*Guardamos cantidad de registros por estado*/
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_CONTACTOS_TEL', :v_estado);
     
    /*Guardamos cantidad total de los registros en padres*/
    EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_CONTACTOS_TEL');
...
BEGIN
     ...
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_CONTROL_CONSULTA', :v_estado);
     
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_CONTROL_CONSULTA');
...
BEGIN
    ...
    DELETE FROM V_D_ANALISIS WHERE ID = :ID;
     ...
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_D_ANALISIS');
...
BEGIN
    ...
    DELETE FROM V_D_DEUDAS_PAGAS WHERE ID = :ID;
     ...
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_D_DEUDAS_PAGAS');
...
BEGIN
    ...
    EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_GENERALES');
...
BEGIN
    ...
    DELETE FROM V_M_DEUDAS WHERE ID = :ID;
     ...
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_M_DEUDAS');
...
BEGIN
    ...
    EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_M_FACTURAS');
    
    DELETE FROM V_M_FACTURAS WHERE id = :I_ID;
END
^
SET TERM ; ^
...
BEGIN
     ...
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_PERSONAS', :v_estado);
...
AS
BEGIN
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_PERSONAS_PACIENTES');
...
AS
BEGIN
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_PERSONAS_PROVEEDORES');
...
BEGIN
     ...
     */
     ...
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_PRODUCTOS', :V_ESTADO);
     
     EXECUTE PROCEDURE SYS_RECCOUNT('D', 'V_PRODUCTOS');
...
BEGIN
     ...
     /*Guardamos cantidad de registros por estado*/
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_ALMACENES', :ESTADO);
     
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('I', 'V_ALMACENES');
...
BEGIN
    ...
    WHERE
     ...
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_ASEGURADOS', :estado);
...
AS
BEGIN
    IF((SELECT DISTINCT (1) FROM V_PERSONAS_PACIENTES WHERE ID = :ID_PACIENTE) IS NULL)THEN
        EXCEPTION E_PACIENTE_NO_ENCONTRADO;
    
    IF((SELECT DISTINCT (1) FROM V_CONTROL_CONSULTA WHERE ID = :ID_CONTROL_CONSULTA) IS NULL)THEN
    ...
    /*Guardamos cantidad de registros por estado*/
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_CONSULTAS', TRUE);
     
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('I', 'V_CONSULTAS');
...
BEGIN
     ...
     /*Guardamos cantidad de registros por estado*/
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_CONTACTOS_DIRECCIONES', TRUE);
     
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('I', 'V_CONTACTOS_DIRECCIONES');
...
BEGIN
    ...
    /*Guardamos cantidad de registros por estado*/
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_CONTACTOS_EMAIL', TRUE);
     
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('I', 'V_CONTACTOS_EMAIL');
...
BEGIN
    ...
    /*Guardamos cantidad de registros por estado*/
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_CONTACTOS_TEL', TRUE);
     
    /*Guardamos cantidad total de los registros en padres*/
    EXECUTE PROCEDURE SYS_RECCOUNT('I', 'V_CONTACTOS_TEL');
...
BEGIN
    IF((SELECT 1 
            ...
            WHERE USER_NAME STARTING WITH :USER_NAME AND 
                    DIA = :DIA AND 
     ...
     /*Guardamos cantidad de registros por estado*/
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_CONTROL_CONSULTA', :ESTADO);
     
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('I', 'V_CONTROL_CONSULTA');
...
BEGIN
    ...
    INSERT INTO V_D_FACTURAS (ID_FACTURA, ID_LINEA, ID_PRODUCTO, CANTIDAD) 
    VALUES (:ID_FACTURA, :ID_LINEA, :ID_PRODUCTO, :CANTIDAD);
...
AS
BEGIN
    INSERT INTO V_M_ENTRADA_PRODUCTOS (ID, ID_PROVEDOR, ID_ALMACEN, COD_FACTURA)
...
BEGIN
     ...
     */
     ...
     IF(( SELECT DISTINCT(1) 
              FROM V_TURNOS t 
              WHERE t.ID = :ID_TURNO AND t.ESTADO) IS NULL)THEN
...
BEGIN
     ID_PERSONA = 0;
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_PERSONAS', :ESTADO);
     ...
     VALUES ( -1, :PERSONA, :PNOMBRE, :SNOMBRE, :APELLIDOS, :SEXO,:FECHA_NACIMIENTO, :ESTADO) 
     RETURNING ID
     INTO ID_PERSONA;
...
AS
BEGIN
    IF((SELECT 1 FROM V_PERSONAS_PACIENTES p WHERE p.ID = :ID_PACIENTE) IS NULL)THEN
        EXCEPTION E_PACIENTE_NO_ENCONTRADO;
    
    
    INSERT INTO V_PERSONAS_PACIENTES_ATR (ID, PESO_NACIMIENTO_KG, ALTURA, PERIMETRO_CEFALICO, CESAREA,
        TIEMPO_GESTACION)
    VALUES (:ID_PACIENTE, :PESO_NACIMIENTO_KG, :ALTURA, :PERIMETRO_CEFALICO, :CESAREA, :TIEMPO_GESTACION);
...
BEGIN
     ...
     /*Guardamos cantidad de registros por estado*/
     EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_PRODUCTOS', :ESTADO);
     
     /*Guardamos cantidad total de los registros en padres*/
     EXECUTE PROCEDURE SYS_RECCOUNT('I', 'V_PRODUCTOS');
...
BEGIN
    ...
    EXECUTE PROCEDURE SYS_RECCOUNT('I', 'V_RELACION_PADRE_ESTUDIANTE');
END
^
SET TERM ; ^
...
AS
DECLARE VARIABLE lcNombreTabla TYPE OF COLUMN RDB$RELATIONS.RDB$RELATION_NAME;
  ...
  FOR 
    SELECT 
      ...
      FROM
         RDB$RELATIONS
      WHERE
         RDB$SYSTEM_FLAG = 0 AND RDB$RELATION_TYPE = 1
      ORDER BY
         RDB$RELATION_NAME
      INTO
         :lcNombreTabla
   DO BEGIN
        IF(TRIM(:lcNombreTabla) STARTING WITH 'V_')THEN BEGIN
            lcComando = 'SELECT COUNT(*) FROM ' || TRIM(lcNombreTabla) ;
            EXECUTE STATEMENT (lcComando) INTO :lnCantidadFilas ;

            UPDATE OR INSERT INTO V_RECCOUNT (TABLA, CANTIDAD)
            VALUES (TRIM(:lcNombreTabla), :lnCantidadFilas)
            MATCHING (TABLA);
            
            lcComando = 'SELECT COUNT(*) FROM ' || TRIM(lcNombreTabla) ||' WHERE ESTADO';
            EXECUTE STATEMENT (lcComando) INTO :lnCantidadFilas ;
            ...
            lcComando = 'SELECT COUNT(*) FROM ' || TRIM(lcNombreTabla) ||' WHERE ESTADO IS FALSE';
            EXECUTE STATEMENT (lcComando) INTO :lnCantidadFilas ;
...
BEGIN
     ...
     IF(V_ESTADO != :ESTADO)THEN BEGIN
		EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_CARTONES_BINGO', :V_ESTADO);
		EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_CARTONES_BINGO', :ESTADO);
     END
END
^
SET TERM ; ^
...
BEGIN
    ...
    IF(V_ESTADO != :ESTADO)THEN BEGIN
		EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_CONSULTAS', :V_ESTADO);
		EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_CONSULTAS', :ESTADO);
    END
...
BEGIN
     ...
     IF(V_ESTADO != :ESTADO)THEN BEGIN
            EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_CONTACTOS_DIRECCIONES', :V_ESTADO);
            EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_CONTACTOS_DIRECCIONES', :ESTADO);
     END
...
BEGIN
    ...
    */
    ...
    IF(V_ESTADO != :ESTADO)THEN BEGIN
		EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_CONTACTOS_EMAIL', :V_ESTADO);
		EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_CONTACTOS_EMAIL', :ESTADO);
    END
...
BEGIN
    ...
    */
    ...
    IF(V_ESTADO != :ESTADO)THEN BEGIN
		EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('D', 'V_CONTACTOS_TEL', :V_ESTADO);
		EXECUTE PROCEDURE SYS_RECCOUNT_ESTADO('I', 'V_CONTACTOS_TEL', :ESTADO);
    END
...
*/
     ...
     UPDATE V_RECCOUNT
     SET
       CANTIDAD = CANTIDAD + IIF(:tcOperac = 'I', 1, -1)
     ...
     IF (ROW_COUNT = 0) THEN BEGIN 
           ...
           EXECUTE STATEMENT (lcComando) INTO :lnCantidadFilas;
           INSERT INTO V_RECCOUNT(ID, TABLA, CANTIDAD)
               VALUES (NULL, :tcTablax, :lnCantidadFilas);
     END
END
^
SET TERM ; ^
...
*/
     ...
     IF (ROW_COUNT = 0) THEN BEGIN 
           ...
           EXECUTE STATEMENT (lcComando) INTO :lnCantidadFilas;
           INSERT INTO V_RECCOUNT(ID, TABLA, CANTIDAD)
               VALUES (NULL, :tcTablax||' '||:ESTADO , :lnCantidadFilas);
     END
END
^
SET TERM ; ^
...
ALTER TABLE M_ENTRADA_PRODUCTOS ADD CONSTRAINT FK_M_ENTRADA_PRODUCTOS_0
  FOREIGN KEY (IDPROVEDOR) REFERENCES PERSONAS (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE M_FACTURAS ADD CONSTRAINT FK_M_FACTURAS_1
  FOREIGN KEY (ID_CONTACTOS_TEL) REFERENCES CONTACTOS_TEL (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE M_FACTURAS ADD CONSTRAINT FK_M_FACTURAS_2
  FOREIGN KEY (ID_CONTACTOS_DIRECCIONES) REFERENCES CONTACTOS_DIRECCIONES (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE M_FACTURAS ADD CONSTRAINT FK_M_FACTURAS_3
  FOREIGN KEY (ID_CONTACTOS_EMAIL) REFERENCES CONTACTOS_EMAIL (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE PERSONAS_PACIENTES_ATR ADD CONSTRAINT FK_PERSONAS_PACIENTES_ATR_0
  FOREIGN KEY (ID_PACIENTE) REFERENCES PERSONAS (ID) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE TURNOS ADD CONSTRAINT FK_TURNOS_0
  FOREIGN KEY (ID_ALMACEN) REFERENCES ALMACENES (ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
